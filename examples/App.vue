...
// 'ctrl+a',
const disallowedHotkeys = ['shift+a', 'ctrl+a', 'ctrl+w', 'ctrl+shift+w', 'ctrl+shift+n', 'ctrl+t', 'ctrl+n', 'ctrl+shift+t', 'ctrl+tab', 'ctrl+pagedown', 'ctrl+shift+tab', 'ctrl+pageup', 'alt+f4', 'cmd+q']
export default {
  name: 'App',
  data () {
    return {
  ...
  methods: {
    handleHotkeyVerify (hotkey) {
      ...
      if (disallowedHotkeys.includes(hotkey.text.toLowerCase())) {
        return false
      }
      console.log('验证：', hotkey, this.hotKeyObj)
